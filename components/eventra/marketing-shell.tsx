        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-10 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
              Designed for campus teams, communities, and independent organizers
              who need clear approval flows, clean attendee ops, and polished
              event commerce.
            </p>
          </div>
          <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
            <Link href="/events">Browse events</Link>
            <Link href="/register/organizer">Organizer registration</Link>
            <Link href="/verify/TKT-DEMO2026">Verify ticket</Link>
          </div>
        </div>
      </footer>
    </div>
